...
const CLOUD_MESSAGING_SERVER_KEY = 'AAAAqeDZmqc:APA91bGBdr-NMXXmo0SzDT_YiSWGk2uKBF38r4eRfWJvoUWQltosnYz9Y8ONBpLfwLEPdy1U4g8cVjByUT7OBnx_6JX67Fao2aXr-BNCes6yz6jHctnlKUxER-wJ7marqy4djMjiX9yr';
...
const firebaseSdk = {
    ...
    getUnReads(userId){
        return new Promise((resolve, reject) => {
            firebase.firestore().collection(this.TBL_ROOM).where('confirmUser', '==', userId).get().then((roomSnap) => {
                let allUnReads = 0;
                roomSnap.forEach(r => {
